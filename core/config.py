...
class Settings:
    ...
    binance_profit_protect_min_profit_pct: float = _f("BINANCE_PROFIT_PROTECT_MIN_PROFIT_PCT", 0.06)
    binance_profit_protect_max_profit_pct: float = _f("BINANCE_PROFIT_PROTECT_MAX_PROFIT_PCT", 0.18)
    binance_profit_protect_stall_sec: float = _f("BINANCE_PROFIT_PROTECT_STALL_SEC", 8.0)
    binance_profit_protect_confirm_sec: float = _f("BINANCE_PROFIT_PROTECT_CONFIRM_SEC", 2.0)
    binance_profit_protect_velocity: float = _f("BINANCE_PROFIT_PROTECT_VELOCITY", 0.00025)
    binance_profit_protect_min_hold_sec: float = _f("BINANCE_PROFIT_PROTECT_MIN_HOLD_SEC", 8.0)
    binance_profit_protect_require_current_confirm: bool = _b("BINANCE_PROFIT_PROTECT_REQUIRE_CURRENT_CONFIRM", True)
